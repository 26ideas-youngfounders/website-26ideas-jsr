-- ============================================================================
-- MENTOR SIGNUP ENHANCEMENTS AND ROBUST DUPLICATE PREVENTION
-- ============================================================================
...
-- 7. Create a view for mentor statistics
...
SELECT 
  ...
  array_agg(DISTINCT unnest(interests)) FILTER (WHERE interests IS NOT NULL) as all_topics_covered,
