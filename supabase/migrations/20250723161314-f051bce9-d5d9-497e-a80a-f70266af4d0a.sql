...
-- Add country_iso_code column to individuals table for proper referencing
ALTER TABLE public.individuals 
...
CREATE INDEX idx_individuals_country_code ON public.individuals(country_code, country_iso_code);
...
-- Update mentor_applications table to include country information
...
-- Add foreign key constraint for mentor_applications
ALTER TABLE public.mentor_applications 
